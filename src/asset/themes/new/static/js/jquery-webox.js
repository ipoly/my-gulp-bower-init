...
$.extend({
	webox:function(option){
		...
		$(document).ready(function(e){
			...
			$('body').append('<div class="background" style="display:none;"></div><div class="webox" style="width:'+width+'px;min-height:'+height+'px;display:none;"><div id="inside" style="min-height:'+height+'px;"><h1 id="locked" onselectstart="return false;">'+(option['title']?option['title']:'webox')+'<a class="span" href="javascript:void(0);"></a></h1>'+(option['iframe']?'<iframe class="w_iframe" src="'+option['iframe']+'" frameborder="0" width="100%" scrolling="yes" style="border:none;overflow-x:hidden;height:'+parseInt(height-30)+'px;"></iframe>':option['html']?'<div id="inside_txt">'+option['html']+'</div>':'')+'</div></div>');
